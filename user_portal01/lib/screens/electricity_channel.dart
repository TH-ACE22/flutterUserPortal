...
class ElectricityChannel extends StatefulWidget {
  const ElectricityChannel({super.key});

  @override
  State<ElectricityChannel> createState() => _ElectricityChannelState();
}

class _ElectricityChannelState extends State<ElectricityChannel> {
  ...
  // Electricity-related members (update as needed).
  ...
  final List<Map<String, String>> staticRequests = [
    {"text": "Power outage in Block A", "status": "Ongoing"},
    {"text": "Meter reading issues", "status": "Received"},
    {"text": "Request for additional transformer", "status": "Ongoing"},
  ];
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Show Members only when not in special categories.
                      if (selectedCategory != "Report" &&
                          selectedCategory != "Requests" &&
                          selectedCategory != "Polls & Survey" &&
                          selectedCategory != "Post") ...[
