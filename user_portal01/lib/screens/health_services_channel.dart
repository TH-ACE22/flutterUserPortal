...
class HealthChannel extends StatefulWidget {
  const HealthChannel({super.key});

  @override
  State<HealthChannel> createState() => _HealthChannelState();
}
...
class _HealthChannelState extends State<HealthChannel> {
  ...
  // Health-related members (modify as needed).
  final List<Map<String, dynamic>> members = [
    {'name': 'Dr. Alice', 'role': 'Doctor', 'image': 'assets/profile_pic.png'},
    {'name': 'Nurse Bob', 'role': 'Nurse', 'image': 'assets/profile_pic.png'},
    {
      'name': 'Patient Carol',
      'role': 'Patient',
  ...
  // Posts for the "Latest" view (initially empty so only dynamic posts appear).
  List<Map<String, dynamic>> posts = [];

  // Sample static requests.
  final List<Map<String, String>> staticRequests = [
    {"text": "Need assistance in Ward 3", "status": "Ongoing"},
    {"text": "Feedback on health services", "status": "Received"},
    {"text": "Extra nurse needed in ER", "status": "Ongoing"},
  ];
  ...
  // Optionally, open CreatePostForm as a modal bottom sheet.

  @override
  Widget build(BuildContext context) {
    // Sort members: doctors/nurses first.
                ...
                flexibleSpace: SafeArea(
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        // Back button: if in special categories, reset to Latest.
                        IconButton(
                          icon: Image.asset(
                            'assets/Back.png',
                            width: 35,
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Show Members only when not in Report, Requests, Polls & Survey, or Post.
                      if (selectedCategory != "Report" &&
                          selectedCategory != "Requests" &&
                          selectedCategory != "Polls & Survey" &&
                          selectedCategory != "Post") ...[
